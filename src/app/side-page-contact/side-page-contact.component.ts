...
@Component({
  selector: 'app-side-page-contact',
  templateUrl: './side-page-contact.component.html',
  styleUrls: ['./side-page-contact.component.scss']
})
export class SidePageContactComponent implements OnInit {
